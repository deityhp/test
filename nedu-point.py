            ...
            for list in list_butt:
                if list.text == "学习":
                    ...
                    titles = driver.find_elements_by_xpath(
                        '//*[@id="contentList"]/div/div/div/div[2]/div[2]/table/tbody/tr/td[2]/div')
                    i = len(titles) + 1
                    ...
                    for tit in range(1, i):
                        ...
                        xpath1 = '//*[@id="contentList"]/div/div/div/div[2]/div[2]/table/tbody/tr[' + str(
                            tit) + ']/td[2]/div'
                        xpath2 = '//*[@id="contentList"]/div/div/div/div[2]/div[2]/table/tbody/tr[' + str(
                            tit) + ']/td[8]/div/a[1]'
